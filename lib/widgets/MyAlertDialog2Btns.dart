...
class MyAlertDialog2Btns extends StatelessWidget {
  final String title, description, positiveBtnText, negativeBtnText;
  ...
  Widget build(BuildContext context) {
    return Dialog(
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(respWidth(30)),
      ),
      elevation: 0.0,
      ...
      child: AlertDialog(
        ...
        contentPadding: EdgeInsets.only(
            left: respWidth(20), right: respWidth(20), top: respHeight(20)),
        actions: <Widget>[
          flatBtn(
              context,
              negativeBtnText ?? GlobalVars.getString(GlobalVars.CANCEL),
              negativeFunc),
          flatBtn(
              context, positiveBtnText ?? GlobalVars.getString(GlobalVars.OK),
              () {
            positiveFunc();
  ...
  Widget flatBtn(BuildContext context, String text, Function func) {
    return FlatButton(
      child: Text(text),
      onPressed: () {
        if (func != null) {
...
//========== customised from original alert class ======
// Examples can assume:
...
class Dialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedPadding(
      padding: EdgeInsets.symmetric(horizontal: respWidth(20), vertical: 24.0),
